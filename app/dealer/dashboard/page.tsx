...
import { AddIcon, BankCardIcon } from "@/components/Icons";
    ...
    <>
      <div className="bg-white rounded-xl p-6 border border-stroke-light">
        ...
        <div className="space-y-3">
          <button className="w-full py-2 px-4 rounded-lg text-xs transition-colors flex items-start  gap-2 bg-brand-blue text-white hover:bg-primary-hover">
            {actions[0].icon}
            {actions[0].label}
          </button>
          <button
            onClick={() => setisBankUpdate(true)}
            className="w-full py-2 px-4 rounded-lg text-xs transition-colors flex items-start  gap-2 bg-white text-gray-700 border border-gray-300 hover:bg-brand-blue hover:text-white"
          >
            {actions[1].icon}
            {actions[1].label}
          </button>
        ...
        <QuickActions
          ...
          actions={[
            ...
            },
            {
              ...
              variant: "secondary",
              icon: <BankCardIcon className="w-4 h-4" />,
            },
          ]}
        />
      </div>
