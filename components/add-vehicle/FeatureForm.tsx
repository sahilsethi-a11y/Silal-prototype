...
export default function FeatureForm({ formState, errors, updateFormField, setStep, handleSubmit }: Readonly<PropsT>) {
    ...
    const handleFetchFeatures = async () => {
        ...
        const fetchedFeatures = [
            "UAE origin certificate",
            "AI product classification",
            "Supplier KYC verified",
            "Retail-ready packaging",
            "Wholesale carton pricing",
            "Batch traceability",
            "Quality check complete",
            "Shelf-life documentation",
            modelName.includes("dates") || modelName.includes("hamper") ? "Corporate gifting ready" : "Catalogue images verified",
            modelName.includes("fabric") || modelName.includes("abaya") ? "Size and color options" : "Cold-chain or storage details",
            modelName.includes("game") ? "Age classification available" : "B2B RFQ enabled",
        ];
