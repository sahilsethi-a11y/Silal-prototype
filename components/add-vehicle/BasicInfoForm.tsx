...
export default function BasicInfoForm({ brands, formState, errors, updateFormField, handleInputChange, filterData, handleSubmit }: Readonly<PropsT>) {
    ...
    const handleValidateJato = async () => {
        ...
        message.success(`Validated and autoloaded ${isZeroKm ? "B2B Wholesale" : "B2C Retail"} listing specs (prototype mock).`);
    ...
    const handleVinLookup = async () => {
        ...
        try {
            ...
            updateFormField("vinLookupMessage", "VIN found on Chaboschi. The entered product details have been approved and the inspection report and images were fetched.");
                    ...
                    <div className="mt-5 rounded-xl border border-stroke-light bg-slate-50 p-4">
                        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">Fetches inspection report and other product details from Chaboschi.</p>
                            </div>
