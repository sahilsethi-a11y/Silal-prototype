...
export const CloseIcon = ({ className }: Readonly<{ className?: string }>) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="14"
...
export const ResetIcon = ({ className }: Readonly<{ className: string }>) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="14"
...
export const EngineIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect width="7" height="7" x="2" y="2" rx="1"></rect>
        <rect width="7" height="7" x="15" y="2" rx="1"></rect>
        <rect width="7" height="7" x="2" y="15" rx="1"></rect>
...
export const BankCardIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const DollerIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const CloseCircleIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const CautionIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const EnternalLinkIcon = ({ className }: { className?: string }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="24"
